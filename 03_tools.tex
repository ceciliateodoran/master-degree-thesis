...
\begin{itemize}
    ...
    modifiche al codice tramite il controllo di versione \textbf{Git}\footnote{https://git-scm.com}. L'azienda ha repository dedicati per ogni progetto, implementando rigorosi controlli di accesso che
...
\begin{itemize}
    ...
    \item \textbf{MySQL}\footnote{https://www.mysql.com/it/}: sistema di gestione di database relazionali (RDBMS) utilizzato in \ac{PAM} per archiviare, organizzare e recuperare dati in modo strutturato.
