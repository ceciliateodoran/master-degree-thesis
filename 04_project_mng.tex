...
Nel caso di clienti esterni, tutte le richieste vengono sempre inoltrate al CEO, il quale gestisce l'intera fase iniziale del progetto.
    ...
    CEO elabora dei \textbf{mockup} utilizzando il software Axure\footnote{https://www.axure.com}. Se le funzionalità richieste sono già presenti in altre
    ...
    inserendo tutti i documenti che ritiene necessari.
        ...
        seguono questa prassi; coloro che lo fanno, utilizzano lo strumento GanttPro\footnote{https://ganttpro.com/it/}. Talvolta, prima di redigere il Gantt, si crea uno \textbf{schema generale di pianificazione
...
continua. Questo rende Scrum difficilmente applicabile nel contesto operativo di \textit{Peer Network}.
    ...
    \subsection{Progetto Software}
        \subsubsection{Avvio}
            ...
            Per affrontare i rischi tecnici di sicurezza, \textit{Peer Network} ha deciso di adottare le linee guida di Intesys\footnote{https://www.intesys.it/information-technology/metodologia-e-approccio/sviluppo-codice-sicuro/}
        ...
        \subsubsection{Esecuzione}
            ...
            \begin{itemize}
                ...
                \begin{itemize}
                    ...
                    Queste informazioni devono seguire lo standard Javadoc\footnote{https://www.oracle.com/java/technologies/javase/javadoc-tool.html};
